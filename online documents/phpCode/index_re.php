...
<span></span><span><a href="#" style="margin-left:2%;">Login</a><span style="color:#fff;">&nbsp;/&nbsp;</span><a href="#">SignUp</a></span>
  </div>
  </form>
    <div class="Doc_tor">
     <div class="Doc_torName"><span style="width: 106px;margin-left: -178%; font-weight: bold;">Doctors Name</span></div>
     <div  class="Doc_torName" style="width: 201px; font-weight: bold;">Package Name</div>
     <div  class="Doc_torName" style="width: 128px; font-weight: bold;">Details</div>
     <div  class="Doc_torName" style="width:83px; font-weight: bold;">Cost</div>
 ...
 ?>
  ...
  ?>
  <div class="Doc_torDet_ls" <?php if($i % 2!=0) { ?> style="background-color:#CCDDBA;" <?php  } ?> >
   <div class="Doc_torName"><img src="img/DSC08574.JPG"  style="width:50px; margin-left:20%; height:50px; border-radius: 70px;"/></div>
    <div class="Doc_torName" style="width: 145px;margin-left:4%;margin-top: 24px;color:#000; word-wrap:break-word; font-size: 14px;">Dr.Abhishek singh</div>
     ...
     <div  class="Doc_torName" style="width:140px; color:#000; font-size: 14px; word-wrap:break-word; margin-left:1%;margin-top: 24px;">Sec.110.Noidarttttttldsldkdskdskldskdsndsndsjdsjdbsj</div>
