...
<div class="navbar navbar-fixed-top">
   <div class="navbar-inner">
     <div class="container">
       ...
       <a class="brand" href="index.php">Share Online Documents</a>
       <div class="nav-collapse" id="main-menu">
        <ul class="nav" id="main-menu-left">
          <li><a onClick="pageTracker._link(this.href); return false;" href="index.php">All</a></li>
          <li><a id="swatch-link" href="/#gallery">Prescription</a></li>
          <li class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">Lab Report <b class="caret"></b></a>
          ...
          <li class="dropdown" id="preview-menu">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">Photograph<b class="caret"></b></a>
