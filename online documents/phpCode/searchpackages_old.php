...
<div class="container">
<div class="hero-unit1 h_top2 r_b2" style="background:#A5B9B5 !important; border-radius:0px; height:40px; color:#fff; font-weight:bold;" >
<div class="row">
...
$obj->search_word($ival);
 ...
 $u=mysql_query("select  PK.RKEY,
			 ...
			 D.email,
			 P.id
 from packages P , doctor_detail D ,package_keywords PK where P.RKEY=PK.RKEY AND keyword='$ival' group by P.RKEY")or die(mysql_error()."STR");
 ...
 <div class="hero-unit h_top" style="padding:0px;border-radius:0px; background-color:antiquewhite;" >
...
//$cntr=0;
 ...
 ?>
            ...
            <div class="hero-unit h_top" <?php if($i%2!=0) { echo 'style="background-color: lavender;padding:0px;border-radius:0px;"'; }else { ?> style="padding:0px;border-radius:0px;" <?php } ?> >
            	
            	<div class="row" style="margin-left:0px;">
            	    <div class="span2" style="margin-left:2px;"><img <?php if($erd[8]=="") { ?> src="img/icon-user-default.png" <?php }else { ?> src="<?php echo $erd[8]; ?>" <?php } ?> /></div>
                    <div class="span2" style="word-wrap:break-word; margin-top:4%;"><h5><a href="Doctor_box.php?id=<?php echo $id; ?>&usr=<?php echo $usr; ?>"><?php echo $erd[9]; ?></a></h5></div>
                    ...
                    <div class="span3" style="width:80px; word-wrap:break-word; margin-top:4%;"><h5><?php if($erd[6]!=0) {  echo "<s>".$erd[5]."</s>"; } else echo $erd[5]; ?></h5></div>
                       <div class="span3" style="width:50px; word-wrap:break-word; margin-top:4%;"><h5><?php echo $erd[6]; ?></h5></div>
                      <div class="span3" style="width:64px; float:left; word-wrap:break-word; margin-top:-1%;margin-left: 273px;"><h5><?php if($erd[6]!=0) { echo $erd[5]-$erd[6]; } else { echo ""; } ?></h5></div>
