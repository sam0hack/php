...
$srch_txt=unhack($s);
	...
	if (!empty($srch_txt))
	{
$engine=mysql_query("select * from mydocs where img_name like'%".$srch_txt."%' AND client_name='$cusername'  order by img_name asc   ")or die(mysql_error()." Searching Error line no 7 search.php");
