   ...
   <div class="navbar-inner">
     <div class="container">
       ...
       <div class="nav-collapse" id="main-menu">
        ...
        <!--   <li><a id="swatch-link" href="pres.php">My Health Card</a></li> -->
          <li><a id="swatch-link" href="Doctor_Profile.php">My Profile</a></li>
          <li><a id="swatch-link" href="addpackage.php">My Search</a></li>
 <li><a id="swatch-link" href="mypackage.php">My Discussion </a></li>
          <li >
         ...
         <li class="dropdown" id="preview-menu">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#"> Categorys<b class="caret"></b></a>
         ...
         require 'database.php';
          ...
          <?php 
          echo  "<li><a href='clienthome.php?f=$qwerty->cat'>$qwerty->cat</a></li>"; 
