...
<div class="navbar navbar-fixed-top" style="width: 940px;margin: 0px auto; padding-top:1px;">
...
<div style=" float:left; margin-left:20px; width:75px; border-right: 1px solid #fff;">
 ...
 <div class="hero-unit1 h_top2 r_b2" style="background:#62CADD !important; border-radius:0px; height:20px; color:#fff; font-weight:bold;" >
<div class="row" style="margin-left:0px;">
<div style=" float:left; width:250px; margin-left:20px;">

                                   <span style="color:#fff; font-family:Verdana, Geneva, sans-serif; font-size:18px;">Operation Patient List
                                  </span>
...
<form method="post">
                   <div class="hero-unit1 h_top2 r_b2" style="background:#62CADD !important; border-radius:0px;  color:#fff;   font-weight:bold; height:25px;  " >
<div class="row" style="margin-left:0px;">
<div style=" float:left; margin-left:40px; width:120px;">
...
<div style=" float:left; width:160px;">
                             ...
                             <div style=" float:left; width:120px;">
                               ...
                               <div style="color:#fff;">Surgery Fess</div>
...
<div style=" float:left; margin-left:30px; width:120px; word-wrap:break-word;">
 <div style="color:#336586;">12.04.2014</div>
                            ...
                            <div style=" float:left;  width:145px; word-wrap:break-word;">
...
<div style=" float:left; width:125px; word-wrap:break-word;">
                            ...
                            <div style=" float:left; width:120px; word-wrap:break-word; ">
                               ...
                               <div style="color:#336586;">50000</div>


                            </div>
                            <div style=" float:left; width:80px; word-wrap:break-word; ">
                             ...
                             <div style=" float:left; width:130px; word-wrap:break-word; ">

                               <div style="color:#000;"><a style="text-decoration:none; color:#1DB05D;" href="">Back to Scheduler</a></div>
    ...
    <div class="hero-unit1 h_top2 r_b2" style="background:#E7EFFC !important; border-radius:0px;  color:#fff;   font-weight:bold;" >
<div class="row" style="margin-left:0px;">
<div style=" float:left; margin-left:30px; width:120px; word-wrap:break-word;">
 <div style="color:#336586;">12.04.2014</div>
